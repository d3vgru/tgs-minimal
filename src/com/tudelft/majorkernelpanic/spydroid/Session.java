...
package com.tudelft.majorkernelpanic.spydroid;
...
import com.tudelft.majorkernelpanic.streaming.Stream;
//ARNOAPI12
/*import com.tudelft.majorkernelpanic.streaming.audio.AACStream;
import com.tudelft.majorkernelpanic.streaming.audio.AMRNBStream;
import com.tudelft.majorkernelpanic.streaming.audio.GenericAudioStream; */
import com.tudelft.majorkernelpanic.streaming.video.H263Stream;
...
import com.tudelft.majorkernelpanic.streaming.video.VideoStream;
...
public class Session {
	...
	public void addVideoTrack(int encoder, int camera, VideoQuality videoQuality, boolean flash) throws IllegalStateException, IOException {
		...
		if (stream != null) {
			...
			// ARNO
			//String descr = stream.generateSessionDescriptor();
			//Log.v(TAG,"ARNO SESSION DESCR " + descr );
		}
	}
